 ...
 * 
 */
@WebServiceClient(name = "BankService", targetNamespace = "http://www.glarimy.com/bank", wsdlLocation = "file:/D:/Glarimy/Workspace/soap/glarimy-bank-client-2.0.0/src/main/java/bank.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/D:/Glarimy/Workspace/soap/glarimy-bank-client-2.0.0/src/main/java/bank.wsdl");
