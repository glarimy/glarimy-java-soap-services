 ...
 * 
 */
@WebServiceClient(name = "BankService", targetNamespace = "http://www.glarimy.com/bank/", wsdlLocation = "file:/D:/Glarimy/Workspace/soap/glarimy-bank-server-2.0.0/src/main/java/bank.wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANKSERVICE_QNAME = new QName("http://www.glarimy.com/bank/", "BankService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/D:/Glarimy/Workspace/soap/glarimy-bank-server-2.0.0/src/main/java/bank.wsdl");
    ...
    public Bank getBankPort() {
        return super.getPort(new QName("http://www.glarimy.com/bank/", "BankPort"), Bank.class);
    }
    ...
    public Bank getBankPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.glarimy.com/bank/", "BankPort"), Bank.class, features);
    }
